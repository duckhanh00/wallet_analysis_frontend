...
function RelationGraph(props) {
    ...
    const handleClickLink = (link) => {
        ...
        // console.log(link_detail[`${link.source.id}_${link.target.id}`])
        ...
        //     .style("color", "#3388cc")
        //     .style("font-size", "15px")
        //     .text(`Address: ${link_detail[`${link.source.id}_${link.target.id}`]}`)
    ...
    return (
        <Fragment>
            <div className="relationship-space-container">
                ...
                <Dropdown className="relationship-space-menu">
