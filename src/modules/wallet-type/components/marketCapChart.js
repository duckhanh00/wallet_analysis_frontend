        ...
        <div className="action__chart">
          <div className="action__1">
            <div className="action">
              <div className="action__btn active">Price</div>
              <div className="action__btn">Market Cap</div>
            </div>

            <div className="date">
              <div className="date__btn">1D</div>
              <div className="date__btn active">7D</div>
              <div className="date__btn">1M</div>
              <div className="date__btn">3M</div>
