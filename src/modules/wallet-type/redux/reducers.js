...
export function RelationGraph(state = {}, action) {
    switch (action.type) {
        case RelationGraphConstants.GET_WALLET_TYPE_REQUEST:
            return {
                ...state,
            }
        case RelationGraphConstants.GET_WALLET_TYPE_SUCCESS:
            return {
                ...state,
                walletType: action.payload
            }
        case RelationGraphConstants.GET_WALLET_TYPE_FAILURE:
            return {
                ...state,
            }
